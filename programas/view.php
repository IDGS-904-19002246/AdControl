                            ...
                            <div>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="detalles/index.php?id=<?php echo $dato['pid']; ?>"
                                            class="menu-link px-3">Ver detalles</a>
                                    </div>
                                    <div class="menu-item px-3">
                        ...
                        <table id="kt_profile_overview_table"
                            ...
                            <thead class="fs-7 text-gray-500 text-uppercase">
                                <tr>
                                    ...
                                    <th class="min-w-50px">Inversión</th>
                                    <th class="min-w-100px">Slogan</th>
                                    <th class="min-w-50px">Horas</th>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center">
                                            <div class="d-flex flex-column justify-content-center">
                                                <span
                                                    class="fs-6 text-gray-800 text-hover-primary"><?php echo $dato['pnombre']; ?></span>
                                                <div class="fw-semibold text-gray-500"><?php echo $dato['ptdescripcion']; ?>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?php echo $dato['pinversion']; ?></td>
                                        <td><?php echo $dato['pslogan']; ?></td>
                                        <td><?php echo $dato['phoras']; ?> Hrs.</td>
                                        <td>
...
<script>
    ...
    btnAbrirModal.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            forms_update.find('.form-control[name="certification"]').val(json.pcertificacion);
