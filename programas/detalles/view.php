...
<body id="kt_body" class="header-extended header-fixed header-tablet-and-mobile-fixed">
    ...
    <div class="container card my-4">
        ...
        <?php if($dato['section'] == null): ?>
        <h4 class="fw-bold py-10 text-center">Este programa/vurso no cuenta con secciones</h4>
        <?php else:?>
        <table class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold mb-10">
            ...
            <tbody>
                ...
                <tr>
                    <td class="p-0"><?php echo $s['name'] ?></td>
                    <td class="p-0"><?php echo $s['desc'] ?></td>
                    <td class="p-0"><button class="btn btn-sm btn-primary btn-update-modal" data-bs-toggle="modal"
                            data-bs-target="#nuevo" data-to-form='<?php echo json_encode($s); ?>'>Editar</button></td>
                    <td class="p-0"><button class="btn btn-sm btn-primary btn-delete-modal btn-delete-modal"
