...
<body id="kt_body" class="header-extended header-fixed header-tablet-and-mobile-fixed">
    ...
    <div class="container card my-4">
        <div class="row d-flex justify-content-between align-items-center py-3 py-lg-6">
            <form id="buscador" method="post" action="index.php" class="col-sm-6 my-0"
...
<div class="multiselect">
    ...
    <div id="checkboxes">
        <label for="one">
            <input type="checkbox" class="checkbox2" data-to-form="1" />First checkbox</label>
        <label for="two">
            <input type="checkbox" class="checkbox2" data-to-form="2" />Second checkbox</label>
        <label for="three">
            <input type="checkbox" class="checkbox2" data-to-form="3" />Third checkbox</label>
    </div>
</div>
<script>
var expanded = false;
