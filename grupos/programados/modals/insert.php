                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <span class="d-flex align-items-center me-2">
                                <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-primary">1</span>
                                </span>
                            ...
                            <span class="d-flex align-items-center me-2">
                                <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-primary">2</span>
                                </span>
                                <span class="d-flex flex-column">
                            ...
                            <span class="d-flex align-items-center me-2">
                                <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-primary">3</span>
                                </span>
                                <span class="d-flex flex-column">
                        ...
                        <div class="col-sm-9">
                            <div class="fv-row mb-10">
                                ...
                                <select name="level" required class="form-control form-control-lg form-control-solid">
